...
export const MyBookings = () => {
  ...
  return (
    <>
      {/* ✅ SEO */}
      <Helmet>
        <title>Kusum Solar - My Bookings</title>
        <meta
          name="description"
          content="Book your Kusum Solar services easily. Fill your details and schedule a solar panel installation or consultation."
        />
        <meta
          name="keywords"
          content="Kusum Solar booking, solar service booking, solar installation, solar consultation"
        />
